...
import {View, RefreshControl, ListRenderItemInfo} from 'react-native';
import {
...
import TeacherTimeTableCard from '../../../components/TeacherComponents/TeacherTimeTableCard/TeacherTimeTableCard';
  ...
  return (
    <View style={appMode === 'DARK' ? darkStyles.container : styles.container}>
      ...
      {isLoading ? (
        ...
        <View style={{zIndex: -1}}>
          {my_timeTable?.calendarData?.length > 0 ? (
            <View>
              <View
                style={{
                  marginTop: hp('3%'),
